class Triangulo2{
  ...
  Triangulo2(float x, float y, int c_, int num_){
    this.c = c_;
    this.num = num_;
    
    construirTriangulo2(new Vec2(x, y));
    queColor(this.c);
  }
  ...
  void construirTriangulo2(Vec2 centro){
    PolygonShape tps = new PolygonShape();
    
    Vec2[] vertices = new Vec2[3];
    vertices[0] = box2d.vectorPixelsToWorld(new Vec2(0, -35.08));
